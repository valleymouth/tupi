...
namespace tupi {
CommandBuffer::CommandBuffer(CommandPoolSharedPtr command_pool)
  ...
  if (vkAllocateCommandBuffers(command_pool_->logicalDevice()->handle(),
                               &create_info, &command_buffer_) != VK_SUCCESS) {
    throw std::runtime_error("Failed to allocate command buffers!");
  }
}

CommandBuffer::~CommandBuffer() {
  vkFreeCommandBuffers(command_pool_->logicalDevice()->handle(),
